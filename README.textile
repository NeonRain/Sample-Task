...
As a an anonymous donator, I need to be able to use a form to submit a one time donation using my credit card.
...
You will need to use Authorize.net's AIM API to submit payment. See here for details: "developer.authorize.net/api/aim/":http://developer.authorize.net/api/aim/.

# Sign up for a test account at "developer.authorize.net/testaccount":https://developer.authorize.net/testaccount
# Check out the AIM documentation at "authorize.net/support/AIM_guide.pdf":http://www.authorize.net/support/AIM_guide.pdf
