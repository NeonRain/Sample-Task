...
# Next you'll want to edit *index.php* to output an HTML page with a form that fits with the requirements above.
# Then you will need to edit *payment.php* to accept the parameters from the form and submit the payment to Authorize.net using the AIM API.
